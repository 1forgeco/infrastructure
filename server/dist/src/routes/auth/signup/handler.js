...
const handleSignup = async (req, res) => {
    const { email, phone, password, fullName, inviteToken, 
    // Owner signup fields
    orgName, slug, cityState, totalCapacity, planId, 
    // Tenant onboarding fields
    roomId, emergencyContactName, emergencyContactPhone, collegeOrCompany, } = req.body;
