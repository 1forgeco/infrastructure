...
exports.handleRecordPayment = void 0;
...
const handleRecordPayment = async (req, res) => {
    ...
    const validMethods = Object.values(client_1.PaymentMethod);
    ...
    if (gateway) {
        const validGateways = Object.values(client_1.PaymentGateway);
    ...
    try {
        // Find the due
        const due = await prisma_1.prisma.due.findFirst({
            where: {
                id: dueId,
                org_id: orgId,
            },
