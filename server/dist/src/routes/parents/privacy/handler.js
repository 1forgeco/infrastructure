...
exports.handleUpdateParentPrivacy = void 0;
const prisma_1 = require("../../../lib/prisma");
const handleUpdateParentPrivacy = async (req, res) => {
    ...
    try {
        ...
        const profile = await prisma_1.prisma.parentProfile.findFirst({
            where: {
                id: parentProfileId,
                org_id: orgId,
            },
        ...
        // Prepare update data
        const updateData = {};
        if (canSeeRoommateContact !== undefined)
            updateData.can_see_roommate_contact = !!canSeeRoommateContact;
        if (canSeeParentContact !== undefined)
            updateData.can_see_parent_contact = !!canSeeParentContact;
        const updatedProfile = await prisma_1.prisma.parentProfile.update({
            where: {
                id: parentProfileId,
            },
            data: updateData,
...
exports.handleUpdateParentPrivacy = handleUpdateParentPrivacy;
